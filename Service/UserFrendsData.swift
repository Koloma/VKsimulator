...
struct Item: Codable {
    ...
    let online, onlineMobile, onlineApp: Int?
    let nickname, domain, bdate: String?
    let city, country: City?
    let photo200_Orig: String?
    let hasMobile, canPost, canSeeAllPosts, canWritePrivateMessage: Int?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case onlineMobile
        case onlineApp
        case nickname, domain, bdate, city, country
        case photo200_Orig
        case hasMobile
        case canPost
        case canSeeAllPosts
        case canWritePrivateMessage
        case mobilePhone
        case homePhone
        case status
        case lastSeen
